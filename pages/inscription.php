...
<body>
    ...
    <div class="container d-flex justify-content-center parent">
        <div class="col-md-8 mt-4">
            ...
            <form class="row  d-flex justify-content-center no-wrap p-2 border border-1  bg-body shadow rounded needs-validation" enctype="multipart/form-data" novalidate action="inscription.php" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-text bg-light bg-primary shadow" style="border:none; " onclick="togglePassword()"><i class="bi bi-eye-slash fs-3" id="togglePassword"></i></span>
                        <div class="valid-feedback"></div>
                        <div class="invalid-tooltip">champ invalide</div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-text bg-light bg-primary shadow " style="border:none; " onclick="togglePasswordConfirm()"><i class="bi bi-eye-slash fs-3" id="togglePasswordConfirm"></i></span>
                        <div class="valid-feedback"></div>
                        <div class="invalid-tooltip">Champ invalide</div>
                    </div>
