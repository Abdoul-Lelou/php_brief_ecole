...
<body class="bg-body">
    ...
    $searchState = false;
        if (isset($_POST['search'])) {
            $search = $_POST['search'];
            $sql = $bdd->prepare('SELECT id,email,passwords,roles,nom,prenom,matricule,etat,date_inscrit,date_archive FROM user WHERE matricule=:matricule and etat=0');
    ...
    <div class="col-md-12  d-flex justify-content-center tableParent ">
        <div class="table-responsive shadow border  col-md-8">
            <form action="archive_user.php  " method="post" class="d-flex justify-content-end pb-4   needs-validation m-4">
                            ...
                            if (isset($searchQuery) && $searchQuery) {
                                for ($i = 0; $i < 1; $i++) {
                                    ...
                                    echo '<tr>';                       
                                            ...
                                            echo '<td>' . $searchQuery['date_archive'] . '</td>';
                            ...
                            for ($i = 0; $i < $limite; $i++) {
                                ...
                                echo '<tr>';                       
                                    if ($donnees = $reponse->fetch() ) {
                                        ...
                                        echo '<td>' . $donnees['date_archive'] . '</td>';
