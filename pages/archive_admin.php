                    ...
                    if ($searchState) {
                        if (isset($searchQuery) && $searchQuery) {
                            for ($i = 0; $i < 1; $i++) {
                                ...
                                echo "<td>  
                                    <span class='d-flex'>                       
                                        <button  class='archive btn btn-outline-danger' data-id='".$searchQuery['id']."' data-toggle='modal' data-target='.bd-archive-modal-sm'  title='Désarchiver'><i class='bi bi-eject'></i></button>";
                                    "</span>";
                                "</td>";
                        ...
                        for ($i = 0; $i < $limite; $i++) {
                            ...
                            if ($donnees = $reponse->fetch()) {
                                ...
                                echo "<td>  
                                    <span class='d-flex'>                       
                                        <button  class='archive btn btn-outline-danger' data-id='".$donnees['id']."' data-toggle='modal' data-target='.bd-archive-modal-sm'  title='Désarchiver'><i class='bi bi-eject'></i></button>";
                                    "</span>";
                                "</td>";
                            } else {
                            }
